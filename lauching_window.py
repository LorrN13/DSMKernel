...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QProgressBar, QLabel, QFrame, QHBoxLayout, QVBoxLayout, QDialog, QSplashScreen
...
class SplashScreen(QWidget):
    def __init__(self):
        ...
        self.setObjectName("spashScreen")
    ...
    def initUI(self):
        ...
        #self.addWidget(self.labelDescription)
        ...
        #self.addWidget(self.labelLoading)
        #self.setLayout(layout)
...
class LogInWindow(QWidget):
    def __init__(self):
        ...
        self.passwordForgotten = QtWidgets.QLabel(self.widget)
        self.passwordForgotten.setGeometry(QtCore.QRect(337, 326, 191, 28))
        self.passwordForgotten.setStyleSheet("color:rgba(0, 0, 0, 200);")
        self.passwordForgotten.setObjectName("label_4")
    ...
    def retranslateUi(self):
        ...
        self.passwordForgotten.setText(_translate("Form", "Forgot your User Name\n or Password?"))
...
if __name__ == '__main__':
    ...
    app.setStyleSheet("""
                      #splashScreen {
                          background-image: url('red_wallpaper.jpg');
                      }
                      """)
